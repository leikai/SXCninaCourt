...
public class LeaveInformalActivity extends Activity {
    private Button btn_back;
    private TextView tv_applicant_No;//编号
    private EditText et_applicant_No;//编号
    ...
    private RadioGroup rg_leave_days;
...
//                            json = "{\"boTableName\":\"请假申请\",\"title\":\"李法官的请假申请\",\"userId\":\"lifaguan\",\"nextParticipants\":\"李法官\",\"boDatas\":{\"BO_EHR_HOLIDAY\":[{\"STAFFNAME\":\"李法官\",\"APPLYDATE\":\"2018-03-13 15:23\",\"HTYPE\":\"事假\",\"BDATE\":\"2018-03-13 15:23\",\"EDATE\":\"2018-03-13 15:23\",\"DAYS\":1,\"MEMO\":\"无\"}]}}";
                            Log.e("",json);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leave_informal);
        initView();
        initData();
        initListener();
    ...
    private void initListener() {
        ...
        btn_leave_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final SoapParams soapParams = new SoapParams().put("name","机关合同制人员请假审批表");//1414 是假数据，应该改成
                new Thread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void initView() {
        ...
        et_applicant_No = (EditText) findViewById(R.id.et_applicant_name_No);
...
//            String endtime = time_end.substring(0,10)+time_start.substring(16);
            ...
            Log.e("tbrq",""+tbrq);
            No = Integer.parseInt(et_applicant_No.getText().toString().trim());
            ...
            object.put("BH",No);//编号
            object.put("XM",user.getUserName());//姓名
            object.put("SZBM",user.getDeptname());//所在部门
...
//            object.put("HTYPE",tv_leaveType.getText().toString().trim());//请假类型
            object.put("KS",starttime);//开始时间
            object.put("JS",endtime);//结束时间
            ...
            obj.put("boTableName","机关合同制人员请假审批表");
            obj.put("title",user.getUserName()+"");

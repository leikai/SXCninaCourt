 ...
 * @author lk
 */
public class ModifyHandlePasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_handle_password);
        getSupportActionBar().hide();
        customActionBar = (CustomActionBar) findViewById(R.id.customActionBar);
        customActionBar.setTitle("手势密码修改");
        ...
        mGestureLockView = (GestureLockView) findViewById(R.id.modify_handle_pwd_glv);
...
//                    String remind = mRemind.getText().toString();
                    if ("请输入原手势密码".equals(mRemind.getText().toString())){
                        if (result.equals(currentUser.getHandPassword())){
                            ...
                            mGestureLockView.clearView();
                            Toast.makeText(ModifyHandlePasswordActivity.this,"对不起，您输入的原密码错误",Toast.LENGTH_SHORT).show();
                        }
                        ...
                        if (setHandlePwdOriginal.equals(result)){
                            ...
                            Toast.makeText(ModifyHandlePasswordActivity.this,"密码修改失败，请重试",Toast.LENGTH_SHORT).show();
                            mGestureLockView.clearView();

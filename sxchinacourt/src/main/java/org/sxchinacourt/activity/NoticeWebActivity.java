...
public class NoticeWebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initWebView();
        webView.loadUrl("http://111.53.181.200:8087/mcourtoa/moffice/sign/list_yiban.html?token="+ceshi+"&flowname=tzgg");
    }
...
//        }
    ...
    public void onBackPressed() {
        if (webView.canGoBack()){
            if(webView.getUrl().equals("http://111.53.181.200:8087/mcourtoa/moffice/sign/list_yiban.html?token="+ceshi+"&flowname=tzgg")){
                super.onBackPressed();
            }else{ webView.goBack();
            }
        }else{

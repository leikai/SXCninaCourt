...
public class FileReverseDataActivity extends Activity{
    ...
    ArrayList<FileReverseDetailDataBean> pickedupList = new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_ll_activity_reverseed);
    ...
    private class PreviewHandler extends Handler {
        ...
        PreviewHandler(FileReverseDataActivity activity) {

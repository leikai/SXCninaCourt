...
public class FileDepositDataActivity extends Activity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sample_ll_activity_deposited);
    ...
    private void setAdapter() {
        ...
        mDataAdapter.setOnDelListener(new SwipeMenuAdapter.onSwipeListener() {
            ...
            public void onDel(int pos) {
                Toast.makeText(FileDepositDataActivity.this, "删除:" + pos, Toast.LENGTH_SHORT).show();
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<FileDepositDataActivity> ref;

        PreviewHandler(FileDepositDataActivity activity) {
        ...
        public void handleMessage(Message msg) {
            final FileDepositDataActivity activity = ref.get();

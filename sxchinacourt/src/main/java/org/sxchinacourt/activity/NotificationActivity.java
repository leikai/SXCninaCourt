...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pgl = (ProgressBar) findViewById(R.id.progressBar1);
        ...
        webviewMsg.addJavascriptInterface(new TabsActivity.TestJavaScriptInterface(),"android");
        //打开DOM存储API
        ...
        webviewMsg.loadUrl("http://192.168.5.1:9000/mcourtoa/moffice/sign/list_daiban.html?token="+ceshi);
        ...
        protected void onPostExecute(String url) {
            try {
                if (!TextUtils.isEmpty(url)) {
                    ...
                    Toast.makeText(NotificationActivity.this, "附件的下载地址无效", Toast.LENGTH_LONG).show();
                }
            } finally {
    ...
    private void openFile(int which) {
        ...
        if (mFileName.endsWith(".doc")) {
            ...
            File file = new File(filePath);
            intent = FileOpenHelper.getWordFileIntent(NotificationActivity.this,file);
            ...
            String filePath = FileAccessUtil.getDirBasePath(FileAccessUtil.FILE_DIR+mFileName);
            File file = new File(filePath);
            intent = FileOpenHelper.getExcelFileIntent(NotificationActivity.this,file);
            ...
            String filePath = FileAccessUtil.getDirBasePath(FileAccessUtil.FILE_DIR+mFileName);
            File file = new File(filePath);
            intent = FileOpenHelper.getTextFileIntent(NotificationActivity.this,file);
        } else if (mFileName.endsWith(".pdf")) {
            String filePath = FileAccessUtil.getDirBasePath(FileAccessUtil.FILE_DIR+mFileName);
            File file = new File(filePath);
            intent = FileOpenHelper.getPdfFileIntent(NotificationActivity.this,file);
        } else if (mFileName.endsWith(".jpg")  ) {
            String filePath = FileAccessUtil.getDirBasePath(FileAccessUtil.FILE_DIR+mFileName);
            File file = new File(filePath);
            intent = FileOpenHelper.getImageFileIntent(NotificationActivity.this,file);

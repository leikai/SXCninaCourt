...
public class RevisionNormalDialog implements OnClickListener{
	 ...
	 * @param scale
	 */
	public RevisionNormalDialog(Activity context,String lic,String userName,String fieldName, float scale){
	 ...
	 * @param scale
	 */
	private void initDialog(float scale){
...
//	    lp.height = (int) (dm.heightPixels / 2.5); // 高度
	...
	private void initIAppRevisionView(){
		...
		//设置手写笔的颜色、宽高、笔型
		demo_revision_view.configSign(Color.BLACK, 10 * dm.density, iAppRevisionView.TYPE_BALLPEN); 

...
public class WebServiceUtilbak {
    // 定义webservice的命名空间
    public static final String SERVICE_NAMESPACE = "http://WebXml.com.cn/";
    // 定义webservice提供服务的url
    public static final String SERVICE_URL = "http://www.webxml.com.cn/webservices/weatherwebservice.asmx";
    ...
    public static List<String> getProvinceList() {
        ...
        try {
            ...
            SoapObject soapObject = new SoapObject(SERVICE_NAMESPACE,
                    methodName);
            soapObject.addProperty("byProvinceName","山西");

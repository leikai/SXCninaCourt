...
public class DateTimePicker extends FrameLayout {
    ...
    public DateTimePicker(Context context) {
        ...
        mYearSpinner.setMinValue(mDate.get(Calendar.YEAR));
        mYearSpinner.setMaxValue(mDate.get(Calendar.YEAR) + 30);
    ...
    private void updateDateControl() {
        ...
        for (int i = 0; i < 7; ++i) {
            ...
            mDateDisplayValues[i] = (String) DateFormat.format("MM月dd日 EEEE", cal);
        }
